...
public class ImageDeal {
    ...
    public void zoom(int width, int height) throws Exception {
        ...
        if (!file.isFile()) {
            throw new Exception("bean.ImageDeal>>>" + file + " 不是一个图片文件!");
        }
    ...
    public static void main(String[] args) throws Exception {
        String openUrl = "/Users/fengyutian/Desktop/jsc/privacyDemo/web/image/1.jpg";
        String saveUrl = "/Users/fengyutian/Desktop/jsc/privacyDemo/web/image/tmp";
        ImageDeal imageDeal = new ImageDeal(openUrl, saveUrl, "1_132", "jpg");
        ...
        //System.out.println(bean.ImageDeal.class.getResource("/").getFile());
        ///Users/fengyutian/Desktop/jsc/privacyDemo/web/WEB-INF/classes/
    }
